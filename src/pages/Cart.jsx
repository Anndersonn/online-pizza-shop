...
function Cart() {
    ...
    const handleRemovePizza = () => {
        if (window.confirm('Chcesz usunąć wszystkie pizzy?')) {
            dispatch(clearCart())
        }
    }

    const handleRemoveItem = (id) => {
        if (window.confirm('Chcesz usunąć tą pozycję?')) {
 ...
 Kosz</h2>
                            <div className="cart__clear">
                                ...
                                <span onClick={handleRemovePizza}>Opróżnić kosz</span>
                            </div>
                        </div>
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Ilość: <b>{totalCount} szt.</b> </span>
                                <span> Kwota zamówienia: <b>{totalPrice} zł</b> </span>
                            </div>
